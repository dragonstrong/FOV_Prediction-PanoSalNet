...
sds = pickle.load(open("./sds",'rb'), encoding='iso-8859-1')
series = pickle.load(open("./series",'rb'), encoding='iso-8859-1')
print("sds:\n",sds)
print("series:\n",series)
...
modelname = '360net'
model3 = models.load_model('./model3_{}_128_w16_h9_8000'.format(modelname))
